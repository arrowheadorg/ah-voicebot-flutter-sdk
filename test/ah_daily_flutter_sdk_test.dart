...
void main() {
  ...
  test('RoomDetails stores roomUrl and token', () {
    final details = RoomDetails(
      roomUrl: Uri.parse('https://example.daily.co/test-room'),
      token: 'abc123',
    );
  ...
  test('RoomDetails allows null token', () {
    final details = RoomDetails(
      roomUrl: Uri.parse('https://example.daily.co/test-room'),
    );
